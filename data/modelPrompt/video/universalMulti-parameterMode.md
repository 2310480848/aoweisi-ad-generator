...
1. **Instruction 必须用英文**
2. **严格遵循 videoDesc**：提示词内容严格基于 videoDesc 的画面描述、时长、景别、运镜、人物/产品动作、情绪、光影氛围、台词、音效字段，不编造额外信息
3. **人物/产品动作**从 videoDesc 的「人物/产品动作」字段提取，翻译为简洁英文动作描述
...
<storyboardItem videoDesc='（使用者登上浴室台面走向LingkeAI 冲牙器、浴室台面、使用者/LingkeAI 冲牙器/浴室台面、4s、中景、跟踪、使用者走到台面前拿起LingkeAI 冲牙器、好奇、浴室灯光稳定明亮、无台词、脚步声和水流声、A001/A002/A003）' shouldGenerateImage="true"></storyboardItem>
```
